...
#include <string.h>
 ...
 void
GameOfLife (int **life, int h, int w) 
{
...
Nneighbors =
	    ...
	    life[y][x - 1] + life[y][x + 1] + life[y - 1][x - 1] + life[y -
									1][x]
	    + life[y - 1][x + 1];
...
image.Width =
    header[21] * 256 * 256 * 256 + header[20] * 256 * 256 + header[19] * 256 +
    header[18];
  
image.Height =
    header[25] * 256 * 256 * 256 + header[24] * 256 * 256 + header[23] * 256 +
    header[22];
  
image.Size =
    header[5] * 256 * 256 * 256 + header[4] * 256 * 256 + header[3] * 256 +
    header[2];
